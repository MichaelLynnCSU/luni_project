...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import the OpenAI library
// Load environment variables from .env file
_dotenv["default"].config();

// Create an OpenAI client instance with API key
var openai = new _openai["default"]({
  apiKey: "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"
});
//const openai = new OpenAI({ apiKey: process.env.OPENAI_API_KEY });

// Async function to get answers from GPT-3
var getAnswersFromGPT = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(questions, resumeData) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return openai.chat.completions.create({
            ...
            // User message with questions and resume image
            {
              ...
              {
                type: "text",
                text: "Answer these questions: ".concat(JSON.stringify(questions), ".")
              },
              // Resume image
              {
                type: "image_url",
                image_url: {
                  "url": "".concat(resumeData),
                  "detail": 'high'
                }
              }]
            }],
        ...
        case 2:
          ...
          // Parse JSON response
          return _context.abrupt("return", JSON.parse(response.choices[0].message.content.replace("```json", "").replace("```", "")));
        case 5:
        case "end":
  ...
  return function getAnswersFromGPT(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Export function 
var _default = exports["default"] = getAnswersFromGPT;