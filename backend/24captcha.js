...
const baseUrl = 'https://24captcha.online/<action>.php';
...
// Create client
const client = new TwoCaptchaClient('18d47e40b1ffe257e61488b8a3e12e9b', {
    timeout: 60000,
    polling: 5000,
    throwErrors: false
});

// Test decoding captcha
client.decodeHCaptcha({
    sitekey: '00000000-0000-0000-0000-000000000000',
    pageurl: 'https://www.odoo.com/fr_FR/jobs/apply/outbound-partner-development-sales-dubai-1458'
}).then(response => {
